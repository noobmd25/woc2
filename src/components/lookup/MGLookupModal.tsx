                    ...
                    <div className="flex flex-col text-center gap-2">
                        ...
                        {medicalGroup === MEDICAL_GROUP.VITAL && (
                            <a
                                ...
                                <span className="underline dark:text-blue-400 text-blue-600 font-bold bg-gray-300 px-2 py-1 rounded">See Unattached Group Here</span>
                            </a>)
                        }
                        {medicalGroup === MEDICAL_GROUP.MMM && (
                            <a
                                ...
                                <span className="underline dark:text-blue-400 text-blue-600 font-bold bg-gray-300 px-2 py-1 rounded">See IPA B group Here</span>
                            </a>)
                        }
                    </div>
                )}
