...
export const PLANS = [
	{
		name: "Triple S Advantage/Unattached",
...
export type SecondPhonePref =
	(typeof SECOND_PHONE_PREFS)[keyof typeof SECOND_PHONE_PREFS];
...
export type SortField =
	(typeof DIRECTORY_SORT_FIELDS)[keyof typeof DIRECTORY_SORT_FIELDS];
...
export const ERROR_MESSAGES = {
	...
	NO_SPECIALTIES_RETURNED:
		"No specialties returned (possible RLS / role issue).",
	SPECIALTY_LIST_EMPTY:
		"Specialty list empty. Check RLS / viewer role mapping.",
